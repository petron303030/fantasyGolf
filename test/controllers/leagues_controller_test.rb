...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { commissioner: @league.commissioner, name: @league.name, numMembers: @league.numMembers }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { commissioner: @league.commissioner, name: @league.name, numMembers: @league.numMembers }
    assert_redirected_to league_path(assigns(:league))
  end
